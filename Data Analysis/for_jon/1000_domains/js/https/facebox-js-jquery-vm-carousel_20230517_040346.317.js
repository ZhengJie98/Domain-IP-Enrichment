...
(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		speed: 400,
		autoplay: true,
		items_to_show: 5, // 0 for auto calc
		min_items_to_show: 1,
		items_to_slide: 1,
		dont_cut: true,
		centered: false,
	...
	Plugin.prototype = {
		...
		init_controls: function()
		{
			...
			// Controls
			this.$btn_left = this.$container.append('<a href="" class="vmc-arrow-left" title=" Previous "></a>').find('.vmc-arrow-left');
			this.$btn_right = this.$container.append('<a href="" class="vmc-arrow-right" title=" Next "></a>').find('.vmc-arrow-right');
