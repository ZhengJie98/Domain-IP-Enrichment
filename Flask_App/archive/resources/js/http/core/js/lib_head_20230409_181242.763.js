...
jQuery(function($){
	...
	$.datepicker.setDefaults($.datepicker.regional['es_CO']);
});
...
var select2arrayoflanguage = {
	matches: function (matches) { return matches + " Algunos resultados encontrados. Usa las flechas para seleccionar."; },
