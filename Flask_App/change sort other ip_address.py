...
with client.start_session() as session:
    ...
    for doc in cursor:
        ...
        updated_doc = doc
        try:
            ip_list = updated_doc['dns_info']['gethostbyname_ex']['other_ip_address']
            print("before sort:", ip_list)
            ip_list.sort()
            print("after sort:", ip_list)
            updated_doc['dns_info']['gethostbyname_ex']['other_ip_address'] = ip_list
