...
function checkPhone(el) {
  ...
  $('<label id="form-contact-phone-error" class="error" for="form-contact-phone">Please enter a valid ' + countryName + " phone.</label>").insertAfter($(el).closest(".intl-tel-input"));
  return false;
}
