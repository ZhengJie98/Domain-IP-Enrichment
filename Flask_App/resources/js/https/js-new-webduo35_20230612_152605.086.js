	...
	$.post("new-webdata.php", $('#desktopregister #formRegister').serialize(),
		function(data)
		{
			  ...
			  {  
				...
				$('#desktopregister #statusRegister').removeClass().addClass('alert alert-sm alert-success').text('Registrasi Sukses!, Selamat Bergabung, silakan isi data login Anda di form Login').fadeIn(900);
