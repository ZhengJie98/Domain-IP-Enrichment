...
GB_hide=function(){
	...
	if(do_reload == true) {
		...
		//$('site_added').update("Site added").show()
	}
};
...
var _left_round=AJS.TD({"class":"left_round"});
var _right_round=AJS.TD({"class":"right_round"});
if(this.show_close_img){
var _58=AJS.IMG({"src":this.img_close});
var _59=AJS.SPAN(typeof(__gb_close_text) != 'undefined' ? __gb_close_text : "Close");
...
AJS.ACN(tbody_header,AJS.TR(_left_round,_56,_57,_right_round));
