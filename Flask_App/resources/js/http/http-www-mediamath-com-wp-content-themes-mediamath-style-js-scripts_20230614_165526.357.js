...
mr = (function (mr, $, window, document){
    ...
    var documentReady = function($){
        // Uncomment this to add additional top navigation menu item
	// $('<a class="btn btn--sm type--uppercase" href="https://platform.mediamath.com/" target="_blank"> <span class="btn__text">Platform Login</span> </a>').insertBefore('#menu1 .stack-header-buttons .btn--primary');
    };
