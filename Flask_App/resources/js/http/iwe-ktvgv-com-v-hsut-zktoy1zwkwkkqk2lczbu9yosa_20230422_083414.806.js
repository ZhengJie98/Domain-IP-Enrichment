...
if (!VisitWeb.showBlock[244094]) VisitWeb.showBlock[244094] = function  () {
    ...
    if (!VisitWeb.blocks[bid]) {
        ...
        var settings = {};
                    ...
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/525077.1657987423.2178.jpeg',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=LLQP7jsyh9Gcx_8T8aW9oCdhjiYDd9oDyALX9InY_vwddlZuahl1rEnaZh2dFT6FCz4teXqAfn6_M-hH_txwlqEPWd_j0qPudwIhFG-_nIhvI0Wyu2aBtQk',
                text: 'Tuxedos and Suits 70% OFF'
            };
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/516183.1652545542.0093.jpeg',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=A5O9zKTUgnPoSGbwYKcO3M5Ct_qwG7Hu0w5ui0W-me9tH7GhGmKuk8PZtiXtwYt45JN6RhAbHEHC8jCcZ4DVS7ZeOiaUbmdWup1lpZ5Xy1ou-pFdPNrJWGM',
                text: 'Cuba Dental Vacation $50 Recoup Holiday Costs No te Pierdas'
            };
                
        block.data     = data;
        block.id       = bid;
        block.sec_id   = 'phsUt_Zktoy1ZWKwkKqK2Lczbu9YOsA2';
        block.ref      = 'r2b8ROGMIws9eFBS0GPUGD-0Wd7Xogg';
        block.settings = {};
        ...
        settings.tables        = 1;
        settings.cssCheat      = '';
        settings.xwidth        = '460px';
        settings.xheight       = '80px';
        ...
        settings.type                = 'standard';
                    ...
                    block.container_id     = 'vhsUt_Zktoy1ZWKwkKqK2Lczbu9YOsA';
            block.old_container_id = 'visitweb_container_244094';
...
if (!document.getElementById('vhsUt_Zktoy1ZWKwkKqK2Lczbu9YOsA') && !document.getElementById('visitweb_container_244094'))
{
    document.write('<div id="vhsUt_Zktoy1ZWKwkKqK2Lczbu9YOsA"></div>');
}
...
if (!VisitWeb.staticScript)
{
    ...
    VisitWeb.blocksQueue.push(244094);
