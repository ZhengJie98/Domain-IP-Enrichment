...
layui.define("layer", function (e) {
    ...
    p.prototype.config = {
        ...
        var t = this, e = t.config = i.extend({}, t.config, o.config, e), n = e.elem.next();
...
layui.define("form", function (e) {
    ...
    var i = layui.$, a = layui.form, n = {
            config: {}, index: layui.atree ? layui.atree.index + 1e4 : 0, set: function (e) {
                var a = this;
        ...
        }, l = "tree", t = "layui-tree", s = "layui-tree-set", d = "layui-tree-iconClick", c = "layui-icon-addition",
        h = "layui-icon-subtraction", o = "layui-tree-entry", u = "layui-tree-main", p = "layui-tree-txt",
        f = "layui-tree-pack", y = "layui-tree-spread", v = "layui-tree-setLineShort", C = "layui-tree-showLine",
        m = "layui-tree-lineExtend", k = function (e) {
            var a = this;
            a.index = ++n.index, a.config = i.extend({}, a.config, n.config, e), a.render()
        };
    k.prototype.config = {
        data: [],
        showCheckbox: !1,
        ...
        return l[0] && l.remove(), a.showSearch && n.prepend('<input type="text" class="layui-input layui-tree-search" placeholder="请输入关键字进行过滤">'), e.elem = n, e.emptyText = i('<div class="layui-tree-emptyText">' + a.emptyText + "</div>"), r.html(e.elem), 0 == e.elem.find(".layui-tree-set").length ? void e.elem.append(e.emptyText) : (a.drag && e.drag(), a.showCheckbox && e.renderForm("checkbox"), e.elem.find(".layui-tree-set").each(function () {
            i(this).parent(".layui-tree-pack")[0] || i(this).addClass("layui-tree-setHide"), !i(this).next()[0] && i(this).parents(".layui-tree-pack").eq(1).hasClass("layui-tree-lineExtend") && i(this).addClass(v), i(this).next()[0] || i(this).parents(".layui-tree-set").eq(0).next()[0] || i(this).addClass(v)
        }), void e.events())
        ...
        layui.each(l, function (a, l) {
            ...
            var c = l.children && l.children.length > 0,
                ...
                o = i(["<div " + (r.key ? 'data-key="' + (l[r.key] || "") + '"' : "") + ' class="layui-tree-set' + (t(l[r.key]) ? " layui-tree-spread" : "") + (d(l[r.key]) ? " layui-tree-checkedFirst" : "") + '">', "<div " + (r.drag && !l.fixed ? 'draggable="true"' : "") + ' class="layui-tree-entry">', '<div class="layui-tree-main layui-inline">', function () {
                    ...
                    return r.isJump && l.href ? '<a href="' + l.href + '" target="_blank" class="' + p + '">' + (l.label || r.defaultNodeName) + "</a>" : '<span class="' + p + '">' + (l.label || r.defaultNodeName) + "</span>"
                }(), "</div>", function () {
                    if (!r.edit) return "";
                    var e = {
            ...
            c && (o.append(h), n.tree(h, l.children)), e.append(o), o.prev("." + s)[0] && o.prev().children(".layui-tree-pack").addClass("layui-tree-showLine"), c || o.parent(".layui-tree-pack").addClass("layui-tree-lineExtend"), n.spread(o, l), r.showCheckbox && n.checkClick(o, l), r.edit && n.operate(o, l)
        })
    }, k.prototype.spread = function (e, i) {
        var a = this, n = a.config, r = e.children("." + o), l = r.children("." + u), t = r.find("." + d),
            v = r.find("." + p), C = n.onlyIconControl ? t : l, m = "";
        C.on("click", function (i) {
            var a = e.children("." + f),
                r = C.children(".layui-icon")[0] ? C.children(".layui-icon") : C.find(".layui-tree-icon").children(".layui-icon");
            if (a[0]) {
                if (e.hasClass(y)) e.removeClass(y), a.slideUp(200), r.removeClass(h).addClass(c); else if (e.addClass(y), a.slideDown(200), r.addClass(h).removeClass(c), n.accordion) {
                    var l = e.siblings("." + s);
                    l.removeClass(y), l.children("." + f).slideUp(200), l.find(".layui-tree-icon").children(".layui-icon").removeClass(h).addClass(c)
                }
            } else m = "normal"
        }), v.on("click", function () {
            m = e.hasClass(y) ? n.onlyIconControl ? "open" : "close" : n.onlyIconControl ? "close" : "open", n.click && n.click({
                elem: e,
                state: m,
                data: i
            })
        ...
        t.on("click", 'input[name="layuiTreeCheck"]+', function (l) {
            ...
            if (!t.prop("disabled")) {
                ...
                var h = function (e) {
                    if (e.parents("." + s)[0]) {
                        var i, a = e.parent("." + f), n = a.parent(), r = a.prev().find('input[name="layuiTreeCheck"]');
                        d ? r.prop("checked", d) : (a.find('input[name="layuiTreeCheck"]').each(function () {
                            this.checked && (i = !0)
                        }), i || r.prop("checked", !1)), h(n)
                    }
                };
                h(e), r.oncheck && r.oncheck({elem: e, checked: d, data: a}), n.renderForm("checkbox")
            }
        })
        ...
        l.children(".layui-tree-btnGroup").on("click", ".layui-icon", function (l) {
            layui.stope(l);
            var u = i(this).data("type"), k = e.children("." + f), g = {data: a, type: u, elem: e};
            if ("add" == u) {
                k[0] || (r.showLine ? (t.find("." + d).addClass("layui-tree-icon"), t.find("." + d).children(".layui-icon").addClass(c).removeClass("layui-icon-file")) : t.find(".layui-tree-iconArrow").removeClass("hide"), e.append('<div class="layui-tree-pack"></div>'));
                var x = r.operate && r.operate(g), b = {};
                if (b.label = r.defaultNodeName, b[r.key] = x, n.tree(e.children("." + f), [b]), r.showLine) if (k[0]) k.hasClass(m) || k.addClass(m), e.find("." + f).each(function () {
                    i(this).children("." + s).last().addClass(v)
                }), k.children("." + s).last().prev().hasClass(v) ? k.children("." + s).last().prev().removeClass(v) : k.children("." + s).last().removeClass(v), !e.parent("." + f)[0] && e.next()[0] && k.children("." + s).last().removeClass(v); else {
                    var w = e.siblings("." + s), T = 1, L = e.parent("." + f);
                    layui.each(w, function (e, a) {
                        i(a).children("." + f)[0] || (T = 0)
                    }), 1 == T ? (w.children("." + f).addClass(C), w.children("." + f).children("." + s).removeClass(v), e.children("." + f).addClass(C), L.removeClass(m), L.children("." + s).last().children("." + f).children("." + s).last().addClass(v)) : e.children("." + f).children("." + s).addClass(v)
                }
                if (!r.showCheckbox) return;
                if (t.find('input[name="layuiTreeCheck"]')[0].checked) {
                    var A = e.children("." + f).children("." + s).last();
                    A.find('input[name="layuiTreeCheck"]')[0].checked = !0
                }
                n.renderForm("checkbox")
            } else if ("update" == u) {
                var q = t.children("." + p).html();
                t.children("." + p).html(""), t.append('<input type="text" class="layui-inline layui-tree-editInput">'), t.children(".layui-tree-editInput").val(q).focus();
                var N = function (e) {
                    var i = e.val().trim();
                    i = i ? i : r.defaultNodeName, e.remove(), t.children("." + p).html(i), g.data.label = i, r.operate && r.operate(g)
                };
                t.children(".layui-tree-editInput").blur(function () {
                    N(i(this))
                }), t.children(".layui-tree-editInput").on("keydown", function (e) {
                    13 === e.keyCode && (e.preventDefault(), N(i(this)))
                })
            } else {
                if (r.operate && r.operate(g), g.status = "remove", !e.prev("." + s)[0] && !e.next("." + s)[0] && !e.parent("." + f)[0]) return e.remove(), void n.elem.append(n.emptyText);
                if (e.siblings("." + s).children("." + o)[0]) {
                    if (r.showCheckbox) {
                        var F = function (e) {
                            if (e.parents("." + s)[0]) {
                                var a = e.siblings("." + s).children("." + o), r = e.parent("." + f).prev(),
                                ...
                                }), 1 == t && 1 == d && (l.checked = !0, n.renderForm("checkbox"), F(r.parent("." + s))))
                            }
                        };
                        F(e)
                    }
                    if (r.showLine) {
                        ...
                        layui.each(w, function (e, a) {
                            i(a).children("." + f)[0] || (T = 0)
                        }), 1 == T ? (k[0] || (L.removeClass(m), w.children("." + f).addClass(C), w.children("." + f).children("." + s).removeClass(v)), e.next()[0] ? L.children("." + s).last().children("." + f).children("." + s).last().addClass(v) : e.prev().children("." + f).children("." + s).last().addClass(v), e.next()[0] || e.parents("." + s)[1] || e.parents("." + s).eq(0).next()[0] || e.prev("." + s).addClass(v)) : !e.next()[0] && e.hasClass(v) && e.prev().addClass(v)
                    }
                } else {
                    var I = e.parent("." + f).prev();
                    if (r.showLine) {
                        I.find("." + d).removeClass("layui-tree-icon"), I.find("." + d).children(".layui-icon").removeClass(h).addClass("layui-icon-file");
                        var S = I.parents("." + f).eq(0);
                        S.addClass(m), S.children("." + s).each(function () {
                            i(this).children("." + f).children("." + s).last().addClass(v)
                        })
                    } else I.find(".layui-tree-iconArrow").addClass("hide");
                    e.parents("." + s).eq(0).removeClass(y), e.parent("." + f).remove()
                }
                e.remove()
            }
        })
        ...
        e.elem.on("dragstart", "." + o, function () {
            ...
            var n = n || event, r = n.clientY, l = i(this), t = l.parent("." + s), u = t.height(), p = t.offset().top,
                k = e.elem.find("." + s), g = e.elem.height(), x = e.elem.offset().top, b = g + x - 13,
                w = t.parents("." + s)[0], T = t.next()[0];
            if (w) var L = t.parent("." + f), A = t.parents("." + s).eq(0), q = A.parent("." + f), N = A.offset().top,
                F = t.siblings(), I = A.children("." + f).children("." + s).length;
            var S = function (n) {
                if (w || T || e.elem.children("." + s).last().children("." + f).children("." + s).last().addClass(v), !w) return void t.removeClass("layui-tree-setHide");
                if (1 == I) a.showLine ? (n.find("." + d).removeClass("layui-tree-icon"), n.find("." + d).children(".layui-icon").removeClass(h).addClass("layui-icon-file"), q.addClass(m), q.children("." + s).children("." + f).each(function () {
                    i(this).children("." + s).last().addClass(v)
                })) : n.find(".layui-tree-iconArrow").addClass("hide"), n.children("." + f).remove(), n.removeClass(y); else {
                    if (a.showLine) {
                        var r = 1;
                        layui.each(F, function (e, a) {
                            i(a).children("." + f)[0] || (r = 0)
                        }), 1 == r ? (t.children("." + f)[0] || (L.removeClass(m), F.children("." + f).addClass(C), F.children("." + f).children("." + s).removeClass(v)), L.children("." + s).last().children("." + f).children("." + s).last().addClass(v), T || n.parents("." + s)[0] || n.next()[0] || L.children("." + s).last().addClass(v)) : !T && t.hasClass(v) && L.children("." + s).last().addClass(v)
                    }
                    if (a.showCheckbox) {
                        var l = function (a) {
                            if (a) {
                            ...
                            var r = a ? a.siblings().children("." + o) : F.children("." + o),
                                t = a ? a.parent("." + f).prev() : L.prev(),
                                d = t.find('input[name="layuiTreeCheck"]')[0], c = 1, h = 0;
                            0 == d.checked && (r.each(function (e, a) {
                                var n = i(a).find('input[name="layuiTreeCheck"]')[0];
                                0 != n.checked || n.disabled || (c = 0), n.disabled || (h = 1)
                            }), 1 == c && 1 == h && (d.checked = !0, e.renderForm("checkbox"), l(t.parent("." + s) || n)))
                        };
                        l()
                    }
                }
            ...
            k.each(function () {
                if (0 != i(this).height()) {
                    if (r > p && r < p + u) return void (a.dragend && a.dragend("drag error"));
                    if (1 == I && r > N && r < p + u) return void (a.dragend && a.dragend("drag error"));
                    var n = i(this).offset().top;
                    if (r > n && r < n + 15) {
                        if (i(this).children("." + f)[0] || (a.showLine ? (i(this).find("." + d).eq(0).addClass("layui-tree-icon"), i(this).find("." + d).eq(0).children(".layui-icon").addClass(c).removeClass("layui-icon-file")) : i(this).find(".layui-tree-iconArrow").removeClass("hide"), i(this).append('<div class="layui-tree-pack"></div>')), i(this).children("." + f).append(t), S(A), a.showLine) {
                            var l = i(this).children("." + f).children("." + s);
                            if (t.children("." + f).children("." + s).last().addClass(v), 1 == l.length) {
                                var h = i(this).siblings("." + s), y = 1, k = i(this).parent("." + f);
                                layui.each(h, function (e, a) {
                                    i(a).children("." + f)[0] || (y = 0)
                                }), 1 == y ? (h.children("." + f).addClass(C), h.children("." + f).children("." + s).removeClass(v), i(this).children("." + f).addClass(C), k.removeClass(m), k.children("." + s).last().children("." + f).children("." + s).last().addClass(v).removeClass("layui-tree-setHide")) : i(this).children("." + f).children("." + s).addClass(v).removeClass("layui-tree-setHide")
                            } else t.prev("." + s).hasClass(v) ? (t.prev("." + s).removeClass(v), t.addClass(v)) : (t.removeClass("layui-tree-setLineShort layui-tree-setHide"), t.children("." + f)[0] ? t.prev("." + s).children("." + f).children("." + s).last().removeClass(v) : t.siblings("." + s).find("." + f).each(function () {
                                i(this).children("." + s).last().addClass(v)
                            })), i(this).next()[0] || t.addClass(v)
                        }
                        if (a.showCheckbox && i(this).children("." + o).find('input[name="layuiTreeCheck"]')[0].checked) {
                            var g = t.children("." + o);
                            g.find('input[name="layuiTreeCheck"]+').click()
                        }
                        return a.dragend && a.dragend("drag success", t, i(this)), !1
                    }
                    if (r < n) {
                        if (i(this).before(t), S(A), a.showLine) {
                            var x = t.children("." + f), w = i(this).parents("." + s).eq(0),
                                T = w.children("." + f).children("." + s).last();
                            if (x[0]) {
                                t.removeClass(v), x.children("." + s).last().removeClass(v);
                                var h = t.siblings("." + s), y = 1;
                                layui.each(h, function (e, a) {
                                    i(a).children("." + f)[0] || (y = 0)
                                }), 1 == y ? w[0] && (h.children("." + f).addClass(C), h.children("." + f).children("." + s).removeClass(v), T.children("." + f).children("." + s).last().addClass(v).removeClass(C)) : t.children("." + f).children("." + s).last().addClass(v), !w.parent("." + f)[0] && w.next()[0] && T.removeClass(v)
                            } else w.hasClass(m) || w.addClass(m), w.find("." + f).each(function () {
                                i(this).children("." + s).last().addClass(v)
                            });
                            w[0] || (t.addClass("layui-tree-setHide"), t.children("." + f).children("." + s).last().removeClass(v))
                        }
                        if (w[0] && a.showCheckbox && w.children("." + o).find('input[name="layuiTreeCheck"]')[0].checked) {
                            var g = t.children("." + o);
                            g.find('input[name="layuiTreeCheck"]+').click()
                        }
                        return a.dragend && a.dragend("拖拽成功，插入目标节点上方", t, i(this)), !1
                    }
                    if (r > b) return e.elem.children("." + s).last().children("." + f).addClass(C), e.elem.append(t), S(A), t.prev().children("." + f).children("." + s).last().removeClass(v), t.addClass("layui-tree-setHide"), t.children("." + f).children("." + s).last().addClass(v), a.dragend && a.dragend("拖拽成功，插入最外层节点", t, e.elem), !1
                }
            })
        })
        ...
        layui.each(n, function (e, a) {
            ...
            l.find("." + p).each(function () {
                ...
                if (i(this).html().indexOf(r) != -1) {
                    ...
                    var a = function (e) {
                        e.addClass("layui-tree-searchShow"), e.parent("." + f)[0] && a(e.parent("." + f).parent("." + s))
                    };
                    a(e.parent("." + s))
                }
            ...
            }), 0 == l.find(".layui-tree-searchShow").length && e.elem.append(e.emptyText), a.onsearch && a.onsearch({elem: t})
        ...
        a.elem.find("." + s).each(function (a, n) {
            var r = i(this).data("key"), l = i(n).children("." + o).find('input[name="layuiTreeCheck"]+');
            if ("number" == typeof e) {
                if (r == e) return l[0].checked || l.click(), !1
...
layui.define("form", function (a) {
    "use strict";
    var e = layui.form, i = layui.$, t = {
            config: {}, index: layui.transfer ? layui.transfer.index + 1e4 : 0, set: function (a) {
                var e = this;
                return e.config = i.extend({}, e.config, a), e
            }, on: function (a, e) {
                return layui.onevent.call(this, l, a, e)
            }
        }, n = function () {
        ...
        }, l = "transfer", r = "layui-transfer", d = "layui-transfer-topTitle", s = "layui-transfer-search",
        c = "layui-transfer-box", f = "layui-transfer-data", u = "layui-transfer-left", h = "layui-transfer-right",
        o = "layui-transfer-dataLeft", y = "layui-transfer-dataRight", p = "layui-transfer-btnLeft",
        v = "layui-transfer-btnRight", k = "layui-btn-disabled", b = function (a) {
            var e = this;
            e.index = ++t.index, e.config = i.extend({}, e.config, t.config, a), e.render()
        };
    b.prototype.config = {
        title: ["列表一", "列表二"],
        width: 200,
        ...
        var a = this, t = a.config, n = "", l = "", u = [];
        "function" == typeof t.parseData && layui.each(t.data, function (a, e) {
            t.data[a] = t.parseData(e) || e
        });
        var h = 0, o = "", y = 0, p = 0;
        layui.each(t.data, function (a, e) {
            h = 0, layui.each(t.value, function (a, i) {
                if (e.value == i) return h = 1, !0
            }), o = '<li data-title="' + e.title + '"><input lay-skin="primary" type="checkbox" data-index="' + a + '" name="' + (0 == h ? "layTranLeftCheck" : "layTranRightCheck") + '" title="' + e.title + '" value="' + e.value + '" class="layui-input" ' + (e.disabled ? "disabled" : "") + "></li>", 0 == h ? (n += o, y += e.disabled ? 0 : 1) : (l += o, p += e.disabled ? 0 : 1, u.push(a))
        });
        var v = ['<div class="layui-transfer layui-form layui-border-box" id="transfer-' + t.id + '" lay-filter="LAY-Transfer-' + a.index + '">', '<div class="layui-transfer-left layui-transfer-box" data-total="' + y + '">', '<div class="' + d + '"><input lay-skin="primary" name="layTranLeftCheck" lay-filter="layTranLeftCheckAll" type="checkbox" class="layui-input" title="' + t.title[0] + '"></div>', function () {
            return t.showSearch ? '<div class="layui-transfer-search"><input class="layui-input" placeholder="关键字搜索"><i class="layui-icon layui-icon-search layui-transfer-searchI"></i></div><ul class="layui-transfer-data layui-transfer-dataLeft layui-transfer-short">' : '<ul class="layui-transfer-data layui-transfer-dataLeft">'
        }(), n + "</ul>", "</div>", '<div class="layui-transfer-btn">', '<button type="button" class="layui-btn layui-btn-primary layui-transfer-btnRight layui-btn-disabled"><i class="layui-icon layui-icon-next"></i></button>', '<button type="button" class="layui-btn layui-btn-primary layui-transfer-btnLeft layui-btn-disabled"><i class="layui-icon layui-icon-prev"></i></button></div>', '<div class="layui-transfer-right layui-transfer-box" data-arr="' + u + '" data-total="' + p + '">', '<div class="' + d + '"><input lay-skin="primary" name="layTranRightCheck" lay-filter="layTranRightCheckAll" type="checkbox" class="layui-input" title="' + t.title[1] + '"></div>', function () {
            return t.showSearch ? '<div class="layui-transfer-search"><input class="layui-input" placeholder="关键字搜索"><i class="layui-icon layui-icon-search layui-transfer-searchI"></i></div><ul class="layui-transfer-data layui-transfer-dataRight layui-transfer-short">' : '<ul class="layui-transfer-data layui-transfer-dataRight">'
        }(), l + "</ul>", "</div>", "</div>"].join(""), k = i(t.elem), b = k.next("." + r);
        b[0] && b.remove(), a.elem = i(v), k.html(a.elem), a.layTop = a.elem.find("." + d), a.layBox = a.elem.find("." + c), a.laySearch = a.elem.find("." + s), a.layData = a.elem.find("." + f), a.layBox.css({
            width: t.width,
            height: t.height
        }), a.layData.css({
            height: function () {
                return t.height - a.layTop.outerHeight() - a.laySearch.outerHeight() - 2
            }()
        }), a.event(), e.render("checkbox", "LAY-Transfer-" + a.index)
    }, b.prototype.event = function () {
        function a(a) {
            var e = l.find(a).find(".layui-transfer-search"), t = e.children("input").val(), n = e.next();
            n.children("li").each(function () {
                i(this).data("title").indexOf(t) == -1 ? i(this).hide() : i(this).show()
            })
        }

        var t = this, n = t.config, l = t.elem, r = "", s = "",
            c = l.find("." + u).find("." + d).find('input[name="layTranLeftCheck"]'),
            f = l.find("." + h).find("." + d).find('input[name="layTranRightCheck"]'),
            b = l.find("." + u).data("total"), g = l.find("." + h).data("total");
        l.on("click", 'input[name="layTranLeftCheck"]+', function () {
            var a = i(this).prev(), n = a[0].checked, d = l.find("." + o).find('input[name="layTranLeftCheck"]'),
                s = "layTranLeftCheckAll" == a.attr("lay-filter");
            if (!a[0].disabled) {
                if (s) r = "", 0 == b ? a[0].checked = !1 : (d.each(function (a, e) {
                    e.disabled || (e.checked = n, n ? (r += i(d[a]).data("index") + ",", i(d[a]).parent("li").addClass("selected")) : i(d[a]).parent("li").removeClass("selected"))
                }), n ? l.find("." + v).removeClass(k) : l.find("." + v).addClass(k)); else {
                    var f = 1;
                    n ? (d.each(function (a, e) {
                        e.disabled || e.checked || (f = 0)
                    }), 1 == f && (c[0].checked = n), r += a.data("index") + ",", a.parent("li").addClass("selected"), l.find("." + v).removeClass(k)) : (c[0].checked && (c[0].checked = !1), a.parent("li").removeClass("selected"), r = r.replace(a.data("index"), ""), d.each(function (a, e) {
                        e.checked && (f = 0)
                    }), 1 == f && l.find("." + v).addClass(k))
                }
                e.render("checkbox", "LAY-Transfer-" + t.index)
            }
        }), l.on("click", 'input[name="layTranRightCheck"]+', function () {
            var a = i(this).prev(), n = a[0].checked, r = l.find("." + y).find('input[name="layTranRightCheck"]'),
                d = "layTranRightCheckAll" === a.attr("lay-filter");
            if (!a[0].disabled) {
                if (d) s = "", 0 == g ? a[0].checked = !1 : (r.each(function (a, e) {
                    e.disabled || (e.checked = n, n ? (s += i(r[a]).data("index") + ",", i(r[a]).parent("li").addClass("selected")) : i(r[a]).parent("li").removeClass("selected"))
                }), n ? l.find("." + p).removeClass(k) : l.find("." + p).addClass(k)), e.render("checkbox", "LAY-Transfer-" + t.index); else {
                    var c = 1;
                    n ? (r.each(function (a, e) {
                        e.disabled || e.checked || (c = 0)
                    }), 1 == c && (f[0].checked = n), s += a.data("index") + ",", a.parent("li").addClass("selected"), l.find("." + p).removeClass(k)) : (f[0].checked && (f[0].checked = !1), a.parent("li").removeClass("selected"), s = s.replace(a.data("index"), ""), r.each(function (a, e) {
                        e.checked && (c = 0)
                    }), 1 == c && l.find("." + p).addClass(k))
                }
                e.render("checkbox", "LAY-Transfer-" + t.index)
            }
        }), l.on("click", "." + v, function () {
            var d = "";
            if (!i(this).hasClass(k)) {
                l.find("." + o).find("li").each(function () {
                    i(this).hasClass("selected") && i(this).remove()
                });
                var s = l.find("." + h).data("arr"), u = 0;
                layui.each(r.split(","), function (a, e) {
                    if (e) {
                        var i = n.data[e];
                        d += '<li data-title="' + i.title + '"><input lay-skin="primary" type="checkbox" data-index="' + e + '" name="layTranRightCheck" title="' + i.title + '" value="' + i.value + '" class="layui-input" ' + (i.disabled ? "disabled" : "") + "></li>", s += "," + e, u++
                    }
                }), l.find("." + y).append(d), a("." + h), c[0].checked = !1, f[0].checked = !1, i(this).addClass(k), r = "", g += u, b -= u, l.find("." + h).data("total", g), l.find("." + h).data("total", b), l.find("." + h).data("arr", s), e.render("checkbox", "LAY-Transfer-" + t.index), n.onchange && n.onchange(t.getData())
            }
        }), l.on("click", "." + p, function () {
            var r = "";
            if (!i(this).hasClass(k)) {
                l.find("." + y).find("li").each(function () {
                    i(this).hasClass("selected") && i(this).remove()
                });
                var d = l.find("." + h).data("arr"), p = 0;
                layui.each(s.split(","), function (a, e) {
                    if (e) {
                        var i = n.data[e];
                        r += '<li data-title="' + i.title + '"><input lay-skin="primary" type="checkbox" data-index="' + e + '" name="layTranLeftCheck" title="' + i.title + '" value="' + i.value + '" class="layui-input" ' + (i.disabled ? "disabled" : "") + "></li>", d = d.replace(e, "").replace(/(,)+/g, ","), p++
                    }
                }), l.find("." + o).append(r), a("." + u), c[0].checked = !1, f[0].checked = !1, i(this).addClass(k), s = "", g -= p, b += p, l.find("." + h).data("total", g), l.find("." + h).data("total", b), l.find("." + h).data("arr", d), e.render("checkbox", "LAY-Transfer-" + t.index), n.onchange && n.onchange(t.getData())
            }
        }), l.find(".layui-transfer-search").on("keyup", "input", function () {
            var e = i(this).parent("div").parent("div");
            a(e)
        })
        ...
        var e = this, i = e.config, t = e.elem.find("." + h).data("arr"), n = [];
        return layui.each(t.split(",").sort(a), function (a, e) {
            e && n.push(i.data[e])
        }), n
    }, t.render = function (a) {
        var e = new b(a);
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    F.prototype.config = {
        ...
        var l = a.elem, n = l.next("." + v), o = e.elem = t(i(j).render({VIEW_CLASS: v, data: a, index: e.index}));
    ...
    }, F.prototype.reload = function (e, i) {
        var a, l, n = this, o = "string" == typeof e;
        a = o ? i : e, l = o ? e : i, a = a || {}, a.data && a.data.constructor === Array && delete n.config.data, n.config = t.extend(!0, {}, n.config, a), "data" === l ? n.pullData(n.config.page.curr) : n.render()
    }, F.prototype.adjustView = function (e) {
        var t = this, i = "hide" === e;
        t.layFixed[i ? "addClass" : "removeClass"](f), t.layTotal[i ? "addClass" : "removeClass"](f), t.layPage[i ? "addClass" : "removeClass"](f)
        ...
        a[0] && (i.layNone.remove(), a.remove()), e && (l.width(i.elem.width() - 2), i.layMain.find("tbody").html(i.layNone = l), d.cache[i.key] = [], i.adjustView("hide"))
        ...
        var c = this, s = c.config, h = e[s.response.dataName] || [], y = [], p = [], v = [], m = function () {
            ...
            }), c.adjustView(), c.layBody.scrollTop(0), c.layMain.find("tbody").html(y.join("")), c.layFixLeft.find("tbody").html(p.join("")), c.layFixRight.find("tbody").html(v.join("")), c.renderForm(), "number" == typeof e && c.setThisRowChecked(e), c.syncCheckAll(), c.haveInit ? c.scrollPatch() : setTimeout(function () {
                c.scrollPatch()
            }, 50), c.haveInit = !0, l.close(c.tipsIndex), s.HAS_SET_COLS_PATCH || c.setColsPatch(), void (s.HAS_SET_COLS_PATCH = !0))
        };
        return d.cache[c.key] = h, c.layPage[0 == o || 0 === h.length && 1 == n ? "addClass" : "removeClass"](f), r ? m() : 0 === h.length ? (c.renderForm(), c.errorView(s.text.none)) : (m(), c.renderTotal(h), void (s.page && (console.log(o), s.page = t.extend({
