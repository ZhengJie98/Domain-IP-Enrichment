...
function ssxl(xl_){var i_=new Image(1,1);i_.src="http://s9.shinystat.com/cgi-bin/shinystat.cgi?TLR=1&USER="+us_+"&"+xl_+"&RM="+Math.round(Math.random()*2147483647);for(i=0;i<100000;i++);i_.onload=function(){return;}}
...
var ssqS_="http://s9.shinystat.com/cgi-bin/shinystat.cgi?USER="+us_+"&REFER="+r_+"&COLOR="+c_+"&SIZE="+l_+"&RES="+l_+"X"+y_+k_+hr_+j_+vu_+ssid_+n_+SSsdk(sv_)+tf_+"&JS=Y&VJS=4016";
...
if(1) {
    ...
    function ssaCss(){
        var par="";
        try{
            if (typeof tfUGBYI_ != 'undefined') {par+=tfUGBYI_;}
