...
if (!VisitWeb.showBlock[243981]) VisitWeb.showBlock[243981] = function  () {
    ...
    if (!VisitWeb.blocks[bid]) {
        ...
        var settings = {};
                    ...
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/535819.1681637236.7921.png',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=mPImcEGprQTwFSKdscvc3sgfbJe916yWXG_ZC_apx7h05bqUJeRFzO9SKD5qqlK1HwLdK3LM20Oeoz9RIJ2dnyKyieXx-NAM2Qk65n8_qOtV2IRkte1iRdQ',
                text: 'Micropayment Wallet & Earnings Platform'
            };
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/535796.1681543770.7553.png',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=PanyZtk3GJ-BQ3BXK74woU50jo47w9X_7M5eMdes3HIaxSQQq0twgEDPEHuOgnRqx7P-0inQ0oLrwmFnrYQ6AB8oLrKatFR4f3_bCMSMjc4B-cf-UwzwtdQ',
                text: '\u0417\u0430\u0440\u0430\u0431\u043e\u0442\u0430\u0439 \u0411\u0438\u0442\u043a\u043e\u0438\u043d\u044b \u043d\u0430 \u043f\u0440\u043e\u0441\u043c\u043e\u0442\u0440\u0435 \u0440\u0435\u043a\u043b\u0430\u043c\u044b'
            };
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/535800.1681545633.4699.png',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=xUeLY5F-I_2HpMQip6YB1tjPVJlBnRyklUPEI0bWXqQVlqpb1K4XdLqSaEofBg0C2eA1gs1_Q21xWX0LEibslkxVtDydWX9wEsaOJxyx3KtRHLSiSBBlujo',
                text: '\u0411\u0443\u043a\u0441, \u043a\u043e\u0442\u043e\u0440\u044b\u0439 \u043f\u043b\u0430\u0442\u0438\u0442 \u0432 \u0411\u0438\u0442\u043a\u043e\u0438\u043d\u0430\u0445'
            };
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/535817.1681628346.2651.png',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=eUX3p9sBcRVwdlNLZdkg2Bch7uEfmYfAJRVEwpdW9m_DFjg7u31uIH2wHGeW12DwnMXVdBKG7H1s-9JNK6e9xi1ob1LNESem4xt4ZHpSDb3f5q98sL4xDlI',
                text: 'USDT every 5 minute.'
            };
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/535819.1681637266.684.png',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=-4TNbN1vMhiL7y_6ZiTjQPDo3t2mIxbK084zzSkRyomR6VpGfunktDBGOek4qwNdutbX7WQRcZbEpKhkLZOfLsWS3uiGXUwEv46dYf3HYXG9nUq5ZM_dqpE',
                text: 'Micropayment Wallet & Earnings Platform'
            };
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/535817.1681628396.0842.png',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=cqtxqFqywc6AwpK1yffd75WpS-7j--v5gzXqkvQzW72CTN4dTW1Ec1evhgOwJ4P6BBl_DgtL0jRnHkCNL5UOHAgHfMY9nk8FT3QKk-mkRq7nP23QiHZNhwA',
                text: 'USDT \u043a\u0430\u0436\u0434\u044b\u0435 5 \u043c\u0438\u043d\u0443\u0442.'
            };
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/535819.1681637360.8237.png',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=HXQnCnBre5ihhRraAAg5CpOB9hvX1tgbe3Nk9A7sI96OekuhtT44AsuPw4Ox1qrNv-3S4S90qpuYpg-Tha0JhtULreRH60fqRCjLvkhS4XCCwWCHBeE2zgM',
                text: '\u041a\u043e\u0448\u0435\u043b\u0435\u043a \u0434\u043b\u044f \u043c\u0438\u043a\u0440\u043e\u043f\u043b\u0430\u0442\u0435\u0436\u0435\u0439 \u0438 \u041f\u043b\u0430\u0442\u0444\u043e\u0440\u043c\u0430 \u0434\u043b\u044f \u0437\u0430\u0440\u0430\u0431\u043e\u0442\u043a\u0430'
            };
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/535819.1681637173.8637.png',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=f1LoHJwkyHODtHpx2fuyF0DBECaTzbDakraBPBv7c8NxjD1ymi5lEpmDBhjWuMj76MkyS_dYDUnhlcd8vkVCcPNsWxW1T6i5lgtQk3HPAcyh5bUq2mLYMzE',
                text: 'Micropayment Wallet & Earnings Platform'
            };
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/535800.1681545730.5888.png',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=buPbuHe9mMaiwwWf0WzbOw4_3tLVY2oQa0L54erj6uiUGuQ9dzhfeS02iFK_vLOWzZ5KmX3i0XrKyh4OlD_aRmZ9NK0OpWBmSlImaCK9moXYtx_TRwwBY-s',
                text: 'Bitcoin surfing'
            };
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/535819.1681637210.6864.png',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=nPQbMznKCLad-9woV0zvtA8GLVmt18LtfwNiZ0z0PT0rYP-xWHBtYBVYoH8UvZ9OCVBDhqeGCQyYfdLKnK_4SV6HvuXoypBOkUP7dlYf6G99S3JA4P1aEYg',
                text: 'Micropayment Wallet & Earnings Platform'
            };
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/535796.1681544936.4236.png',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=ABLoOyXH37FAtKbWTC-z-RDfC_nMOFH92xoASFCSsH05oNJBdjFZUi7VI1UFxfJcWd1fz_PrZpALqsQHtonZN9kl6XwV4nCbv2ltQeNlERNfRcRVSfE5L9c',
                text: 'Earn Bitcoin by viewing ads'
            };
                    data[data.length] = {
                image: 'http://iwe.ktvgv.com/i/535817.1681628526.5702.png',
                link: 'https://cwpbam.mfcewkrob.com/c?m=c&b=ZnR7MQknzrN-JTtUIgZtT0KixajjW8Hj4vXhxqazBMmSlCpDAJfZFVzHs3mlm_1XsbetsoJZf6NkPczvQlin83zuj5tJyKxJ3VhG9araSLy-yEljUZFau6k',
                text: 'LTC \u043a\u0430\u0436\u0434\u044b\u0435 5 \u043c\u0438\u043d\u0443\u0442.'
            };
                
        block.data     = data;
        block.id       = bid;
        block.sec_id   = 'lPJn6MuPnr7E_pExTbUJNBaXGBw5P4A2';
        block.ref      = 'rVOJPPCThYtfof0vntFc9vtog1jdDrQ';
        block.settings = {};

        settings               = block.settings;
        settings.urlPrefix     = 'http://iwe.ktvgv.com/';
        settings.refLink       = 0;
        settings.error         = '';
        settings.rows          = 1;
        settings.cols          = 4;
        settings.tables        = 3;
        settings.cssCheat      = '';
        settings.xwidth        = '950px';
        settings.xheight       = '110px';
        ...
        settings.teaserBorderColor  = '#C9C9C9';
        settings.teaserBorderStyle  = 'dashed';
        settings.teaserBorder       = 1;

        settings.imageSize         = 100;
        ...
        settings.fontHoverColor      = '#D50303';
        ...
        settings.type                = 'standard';
                    ...
                    block.container_id     = 'vPJn6MuPnr7E_pExTbUJNBaXGBw5P4A';
            block.old_container_id = 'visitweb_container_243981';
...
if (!document.getElementById('vPJn6MuPnr7E_pExTbUJNBaXGBw5P4A') && !document.getElementById('visitweb_container_243981'))
{
    document.write('<div id="vPJn6MuPnr7E_pExTbUJNBaXGBw5P4A"></div>');
}
