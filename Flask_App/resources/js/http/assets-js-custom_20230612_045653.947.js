...
//  Contact Form with validation
    ...
    $("#form-contact-submit").bind("click", function(event){
        $("#form-contact").validate({
            submitHandler: function() {
                $.post("https://www.sganjia.com/admin/contact/save", $("#form-contact").serialize(),  function(response) {
    ...
    $("#form-slider-submit").bind("click", function(event){
        $("#form-slider").validate({
            submitHandler: function() {
                $.post("https://www.sganjia.com/admin/contact/save", $("#form-slider").serialize(),  function(response) {
                    $('#form-slider')[0].reset();
